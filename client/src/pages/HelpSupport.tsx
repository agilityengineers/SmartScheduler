...
export default function HelpSupport() {
  ...
  const handleSendSupportMessage = async () => {
    // Send the message to support@mydailysuccesstracker.co
    setIsSending(true);
    ...
    try {
      ...
      const response = await fetch('/api/support', {
        ...
        body: JSON.stringify({
          ...
          email: 'support@mydailysuccesstracker.co' // The recipient of the support message
        }),
      });
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground">support@mydailysuccesstracker.co</p>
